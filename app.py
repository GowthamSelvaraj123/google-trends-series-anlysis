# Day 75 - Google Trends & Time Series Analysis (Complete)
...
df_btc_search = pd.read_csv("bitcoin_search.csv")
df_btc_price = pd.read_csv("bitcoin_price.csv")
df_ue_2020 = pd.read_csv("us-benefits-search-vs-ue-rate-2004-20.csv")
...
# Drop missing values in BTC price
df_btc_price.dropna(inplace=True)

# ----------------------------------------
# Resample Bitcoin Price to Monthly
# ----------------------------------------
df_btc_monthly = df_btc_price.resample('ME', on='DATE').last()


# ----------------------------------------
# Locators and DateFormatter for Time Axis
# ----------------------------------------
...
# ----------------------------------------
# Rolling Average for Unemployment Search
# ----------------------------------------
plt.figure(figsize=(14,8), dpi=120)
...
# ----------------------------------------
# Unemployment 2004-2020 Data Visualization
# ----------------------------------------
plt.figure(figsize=(14,8), dpi=120)
